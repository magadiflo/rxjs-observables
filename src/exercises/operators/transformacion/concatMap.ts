 ...
 ** 
 ** Beneficios de concatMap
 ** ***********************
 ** Orden secuencial: Asegura que los observables se procesen en el orden en que fueron emitidos.
 ** 
 ** Evita sobrecarga: A diferencia de otros operadores como mergeMap, que puede iniciar múltiples
 ** operaciones simultáneamente, concatMap garantiza que solo un observable se procese a la vez, 
 ** reduciendo la carga.
 ** 
 ** Control de concurrencia: Ideal para escenarios donde es importante mantener el orden y 
 ** la secuencialidad.
 ** 
 ** ***NOTA**
 ** *********
 ** Lo que se espera que el concatMap retorne es un Observable.
 */
